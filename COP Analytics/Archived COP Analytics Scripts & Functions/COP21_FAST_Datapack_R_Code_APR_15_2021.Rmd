...
dplyr::mutate(`Agency Category` = ifelse(`Agency Category` == "USAID", "USAID",
  ...
  write_csv(df_datapack_all,"COP21 FAST and Data Pack Submissions/Dataset/Datapack_Master_05_19_v1.csv")  
...
dplyr::mutate(`Agency Category` = ifelse(`Agency Category` == "USAID", "USAID",
  ...
  write_csv(df_datapack_agg,"COP21 FAST and Data Pack Submissions/Dataset/Datapack_Agg_Master_05_19_v1.csv")  
```
