...
#identify all the FAST files  
  ...
  df.Commodities<- left_join(df.Commodities_pre, df.MechsList, by = "Mechanism   
                            ID")
...
Update the date
```{r}
  write_csv(df.COP21PlanningDataset_Final,"COP22 FAST and Data Pack Submissions/Dataset/FAST_DATAPACK_01_27_22_v1.csv")
```
