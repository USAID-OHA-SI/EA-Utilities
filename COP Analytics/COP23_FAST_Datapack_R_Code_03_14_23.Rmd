...
```{r}
  ...
  df.COP22PlanningDataset<-left_join(df.COP22PlanningDataset, df.MechsList, by = "Mechanism ID") %>% 
  COP22_master_clean()    
...
write_csv(df.COP22PlanningDataset,here("C:/Users/jmontespenaloza/Downloads/test.csv"))
