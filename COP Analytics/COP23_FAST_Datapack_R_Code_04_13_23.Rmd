...
df_dp2<- left_join(df_dp, df.rename, by = "Mechanism ID") %>% 
  dplyr::mutate(countryname2 = case_when(`Country2` == "Brazil"
...
write_csv(df.COP22PlanningDataset_Final,here("C:/Users/jmontespenaloza/Documents/COP23 Tools/FAST_DATAPACK_05_11_23.csv"))


write_csv(df.fast_raw,here("C:/Users/jmontespenaloza/Documents/COP23 Tools/FAST_Raw_05_11_23 (OVC).csv"))
