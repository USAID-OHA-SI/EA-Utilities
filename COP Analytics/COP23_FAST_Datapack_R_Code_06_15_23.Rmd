...
source("~/GitHub/EA-Utilities/COP Analytics/fast_function_SCM_nextgen.R")
...
df_dp2<- left_join(df_dp, df.rename, by = "Mechanism ID") %>% 
  dplyr::mutate(countryname2 = case_when(`Country2` == "Brazil" | `Country2` == "Jamaica" | `Country2` == "Trinidad and Tobago"
     ~ Country, TRUE ~ Country2)) %>% 
...
#identify all the FAST files  
  Fast<- list.files("C:/Users/jmontespenaloza/Documents/COP23 TOOLS/FASTS WHR", full.names = TRUE)
    ...
    Fast<- list.files("C:/Users/jmontespenaloza/Documents/COP23 TOOLS/FASTS", full.names = TRUE)
...
```{r}
  ...
  df.COP22PlanningDataset <-bind_rows(df.COP22PlanningDataset,df_dp2) 
...
write_csv(df.COP22PlanningDataset_Final,here("C:/Users/jmontespenaloza/Documents/COP23 Tools/FAST_DATAPACK_05_26_23.csv"))


write_csv(df.fast_raw,here("C:/Users/jmontespenaloza/Documents/COP23 Tools/FAST_Raw_05_26_23 (OVC).csv"))
