...
# LOAD DATA ============================================================================  
  ...
  df_msd2 <- read_csv("C:/Users/jmontespenaloza/Documents/COP23 Tools/FAST_DATAPACK_06_19_23.csv", col_names = TRUE)
  ...
  print_mer_cop20 <- function(mechs){
    ...
    meta <- df_mech %>% 
      ...
      mutate(Country = str_remove_all(Country, " |'"),
             name = glue("COP23 Targets Templates/COP22_{Country}_{`Mechanism ID`}_MER.csv"))
    
    note2<-data.frame(Country="The data above presents COP23 target data from the COP23 Target Setting Tool as of 6/15/2023. Please consult with your A/COR or AM to validate these figures.")
  ...
  dir_create("COP23 Targets Templates")
