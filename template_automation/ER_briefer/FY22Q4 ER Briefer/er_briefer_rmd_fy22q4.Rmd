...
Below is a table of budget execution by program area.  At this more granular level, there can be even more reasonable explanations for apparent over or under expenditure.  Nevertheless, it will be important to explain any budget execution outside of the 90-110\% range, especially if the budget execution deviations do not align with the strategic goals of the country and\/or do not align with achievement of PEPFAR targets. Typically we do not focus on OU\/agency level budget execution as we recognize the nuanced programmatic goals of different mechanisms. That being said, OU\/agency level comparisons are discussed during the COP process and frequently used to defend\/attack budget decisions. Please note that PM is planned at the Prime partner-level only, subrecipient budgets are planned by non-PM program area. However, subrecipients with spending >$25,000 are encouraged to report their PM costs in their individual ER template. Thus no comparison should be made between budget plans of the prime’s PM and the total Prime + Subs’ PM. Prime’s can be assessed based on their budget execution of their PM.
